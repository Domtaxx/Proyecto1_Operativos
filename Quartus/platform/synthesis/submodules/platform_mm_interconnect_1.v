...
module platform_mm_interconnect_1 (
	...
	wire         rsp_mux_src_valid;                                                           // rsp_mux:src_valid -> nios2_instruction_master_agent:rp_valid
	wire  [98:0] rsp_mux_src_data;                                                            // rsp_mux:src_data -> nios2_instruction_master_agent:rp_data
	wire         rsp_mux_src_ready;                                                           // nios2_instruction_master_agent:rp_ready -> rsp_mux:src_ready
	wire   [0:0] rsp_mux_src_channel;                                                         // rsp_mux:src_channel -> nios2_instruction_master_agent:rp_channel
	wire         rsp_mux_src_startofpacket;                                                   // rsp_mux:src_startofpacket -> nios2_instruction_master_agent:rp_startofpacket
	wire         rsp_mux_src_endofpacket;                                                     // rsp_mux:src_endofpacket -> nios2_instruction_master_agent:rp_endofpacket
	...
	wire  [98:0] nios2_instruction_master_agent_cp_data;                                      // nios2_instruction_master_agent:cp_data -> router:sink_data
